  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      new ListView(children: <Widget>[
        ...
        new Container(
            margin: EdgeInsets.fromLTRB(40.0, 0, 40.0, 0),
            child:new TextField(controller: rePasswordController,obscureText:true,decoration: InputDecoration(hintText: ' Confirm Password',labelText: "Re-Type Password: ",contentPadding: EdgeInsets.fromLTRB(10, 0, 10, 0)),style: new TextStyle(fontSize: 25.0,fontFamily: "Lobster"),)
        ),
